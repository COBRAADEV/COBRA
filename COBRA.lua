...
SUDO = SUDO
sudo_users = {SUDO,1084104943,1373388290}   
print([[
> CH › @CoBBRa_TEAM
~> DEVELOPER › @JO_CR0
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/COBRAADEV/Files_Cobra/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCOBRAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(1084104943) then  
var = true  
elseif tonumber(user_id) == tonumber(1373388290) then
var = true  
...
local UserName = (data.username_ or "CoBBRa_TEAM")
...
local COBRA_Msg = ''  
if msgs < 100 then 
COBRA_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
COBRA_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
COBRA_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
COBRA_Msg = 'متفاعل' 
elseif msgs < 1200 then 
COBRA_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
COBRA_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
COBRA_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
COBRA_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
COBRA_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
COBRA_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
COBRA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
COBRA_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
COBRA_Msg = 'رب التفاعل'  
end 
return COBRA_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@JO_CR0")  
...
--------------------------------------------------------------------------------------------------------------
function SourceCOBRA(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."COBRA1:List:Filter"..sl)
...
if not DevCOBRAW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevCOBRAW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,COBRA_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ❂' and DevCOBRAW(msg) then  
...
if text == 'تعطيل التواصل ❂' and DevCOBRAW(msg) then  
...
if text == 'تفعيل البوت الخدمي ❂' and DevCOBRAW(msg) then  
...
if text == 'تعطيل البوت الخدمي ❂' and DevCOBRAW(msg) then  
...
if text == 'ضع كليشه ستارت ❂' and DevCOBRAW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *❂︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ❂' and DevCOBRAW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *❂︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ❂' and DevCOBRAW(msg) then 
...
if text == 'تحديث السورس ❂' and DevCOBRAW(msg) then 
os.execute('rm -rf COBRA.lua')
os.execute('wget https://raw.githubusercontent.com/COBRAADEV/COBRA/main/COBRA.lua')
send(msg.chat_id_, msg.id_,' *❂︙تم تحديث السورس* \n*❂︙لديك اخر اصدار لسورس كوبرا*\n*❂︙الاصدار » { 2.8v}*')
dofile('COBRA.lua')  
end
if text == 'الاصدار ❂' and DevCOBRAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *❂︙اصدار سورس كوبرا* \n*❂︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ❂' and DevCOBRAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ❂︙[تحديثات البوت](t.me/shorohat10) \n❂︙[قناه السورس](t.me/CoBBRa_TEAM)')
end
if text == "ضع اسم للبوت ❂" and DevCOBRAW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *❂︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ❂' and DevCOBRAW(msg) then 
...
if text == 'المشتركين ❂' and DevCOBRAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❂︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ❂' and DevCOBRAW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *❂︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ❂") and DevCOBRAW(msg) then
...
if text == ("قائمه العام ❂") and DevCOBRAW(msg) then
...
if text == ("قائمه الكتم العام ❂") and DevCOBRAW(msg) then
...
if text=="اذاعه خاص ❂" and msg.reply_to_message_id_ == 0 and DevCOBRAW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❂︙ارسل الان اذاعتك؟* \n*❂︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ❂" and msg.reply_to_message_id_ == 0 and DevCOBRAW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❂︙ارسل الان اذاعتك؟* \n*❂︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ❂" and msg.reply_to_message_id_ == 0 and DevCOBRAW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❂︙ارسل الان اذاعتك؟* \n*❂︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ❂" and msg.reply_to_message_id_ == 0  and DevCOBRAW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *❂︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ❂" and msg.reply_to_message_id_ == 0  and DevCOBRAW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ❂︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ❂' and DevCOBRAW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ❂" and DevCOBRAW(msg) then
...
if text == "تنظيف الكروبات ❂" and DevCOBRAW(msg) then 
...
send(msg.chat_id_, msg.id_,'*❂︙عدد الكروبات الان » { '..#group..' }'..COBRAk..''..COBRA..'*\n*❂︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevCOBRAW(msg) then
...
usertext = '*\n ❂︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'CoBBRa_TEAM')..')'
status  = '\n *❂︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevCOBRAW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *❂︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'CoBBRa_TEAM')..')'
status  = '\n*❂︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevCOBRAW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevCOBRAW(msg) then
...
local COBRA1_Msg = database:get(bot_id.."COBRA1:Add:Filter:Rp2"..text..msg.chat_id_)   
if COBRA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❂︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CoBBRa_TEAM')..') \n ❂︙'..COBRA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if COBRA_Msg and not Special(msg) then  
local COBRA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if COBRA_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❂︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❂︙["..COBRA_Msg.."] \n")
else
send(msg.chat_id_,0," *❂︙العضو :* {["..data.first_name_.."](T.ME/CoBBRa_TEAM)}\n❂︙["..COBRA_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *❂︙عذرا ↫* {["..data.first_name_.."](T.ME/CoBBRa_TEAM)}\n*❂︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevCOBRAW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevCOBRAW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevCOBRAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❂︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevCOBRAW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❂︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ❂" and DevCOBRAW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *❂︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ❂$") and DevCOBRAW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *❂︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ❂" and DevCOBRAW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ❂" and DevCOBRAW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *❂︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ❂" and DevCOBRAW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."COBRA:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."COBRA:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_COBRA = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_COBRA then 
names_COBRA = database:smembers(bot_id.."COBRA:blocname"..msg.chat_id_) or ""
if names_COBRA and names_COBRA[1] then 
for i=1,#names_COBRA do 
if name_COBRA:match("(.*)("..names_COBRA[i]..")(.*)") then 
...
database:set(bot_id.."COBRA:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."COBRA:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."COBRA:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."COBRA:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."COBRA:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_COBRAa_new(COBRA1,COBRA2)
if COBRA2 and COBRA2.first_name_ then 
if COBRA2.first_name_:match("(.*)"..database:get(bot_id.."COBRA:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."COBRA:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local COBRA_nnn = database:get(bot_id.."COBRA:nump"..msg.chat_id_) or 5
local COBRA_nnn2 = database:get(bot_id.."COBRA:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(COBRA_nnn2) == tonumber(COBRA_nnn) or tonumber(COBRA_nnn2) > tonumber(COBRA_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."COBRA:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "❂︙عزيزي >>["..COBRA2.username_.."](https://t.me/"..(COBRA2.username_ or "CoBBRa_TEAM")..")\n❂︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."COBRA:teh"..msg.chat_id_).."} بجانب اسمك\n❂︙عدد المحاولات المتبقيه {"..(tonumber(COBRA_nnn) - tonumber(COBRA_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_COBRAa_new)
end
end
...
local COBRAChengName = database:get(bot_id.."COBRA:Cheng:Name"..data.id_)
if not data.first_name_ then 
if COBRAChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..COBRAChengName..']')
database:del(bot_id.."COBRA:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if COBRAChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."COBRA:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local COBRAChengUserName = database:get(bot_id.."COBRA:Cheng:UserName"..data.id_)
if not data.username_ then 
if COBRAChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..COBRAChengUserName..']')
database:del(bot_id.."COBRA:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if COBRAChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."COBRA:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local COBRAChengPhoto = database:get(bot_id.."COBRA:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if COBRAChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."COBRA:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if COBRAChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."COBRA:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴄᴏʙʀᴀ\n\n[❂  ᴄᴏʙʀᴀ ᴄʜᴀɴɴᴇʟ](http://t.me/shorohat10)\n\n[❂  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/CoBBRa_TEAM)\n\n[❂  ᴄᴏʙʀᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/JO_CR0)\n\n[❂  ʙᴏᴛ ᴄᴏʙʀᴀ](http://t.me/CoBRa_TEAMBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❂ sᴏᴜʀᴄʀ ᴄᴏʙʀᴀ',url="t.me/CoBBRa_TEAM/5"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/shorohat10&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevCOBRAW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*❂︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CoBBRa_TEAM')..') \n*❂︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *❂︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CoBBRa_TEAM')..') \n*❂︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevCOBRAW(msg) then
dofile('COBRA.lua')  
send(msg.chat_id_, msg.id_, ' *❂︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevCOBRAW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevCOBRAW(msg) then  
function start_function(extra, result, success)
if COBRASudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevCOBRAW(msg) then  
...
if COBRASudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*❂︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevCOBRAW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if COBRASudoBot(userid) then
send(msg.chat_id_, msg.id_,"*❂︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevCOBRAW(msg) then  
function start_function(extra, result, success)
if COBRASudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*❂︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevCOBRAW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevCOBRAW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if COBRASudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*❂︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevCOBRAW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevCOBRAW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevCOBRAW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevCOBRAW(msg) then
...
if text == 'الملفات' and DevCOBRAW(msg) then
t = ' *❂︙ملفات السورس كوبرا ↓*\n*•━━━━━━ 𝘾𝙊 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevCOBRAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/COBRAADEV/Files_Cobra/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *❂︙اهلا بك في متجر ملفات كوبرا*\n*❂︙ملفات السورس ↓*\n*•━━━━━━ 𝘾𝙊 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝘾𝙊 ━━━━━━━•*\n *❂︙علامة تعني { ✓ } ملف مفعل*\n *❂︙علامة تعني { ✘ } ملف معطل*\n *❂︙قناة سورس كوبرا ↓*\n".." *❂︙*[اضغط هنا لدخول](t.me/CoBBRa_TEAM) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevCOBRAW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/COBRAADEV/Files_Cobra/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('COBRA.lua')  
else
send(msg.chat_id_, msg.id_," *❂︙عذرا الملف لايدعم سورس كوبرا* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevCOBRAW(msg) then
...
if text == "مسح الملفات" and DevCOBRAW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *❂︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevCOBRAW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevCOBRAW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "CoBBRa_TEAM")
...
function Function_COBRA(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_COBRA, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_COBRA, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❂︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'CoBBRa_TEAM')..')'
status  = '\n*❂︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *❂︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'CoBBRa_TEAM')..')'
status  = '\n*❂︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *❂︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *❂︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'CoBBRa_TEAM')..')'
...
database:set(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *❂︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."COBRA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."COBRA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *❂︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."COBRA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."COBRA1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."COBRA1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *❂︙ارسل الكلمه الان*")  
database:set(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COBRA1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."COBRA1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."COBRA1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."COBRA1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."COBRA1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."COBRA1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevCOBRAW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *❂︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevCOBRAW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *❂︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'CoBBRa_TEAM')..')'..'\n*❂︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevCOBRAW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevCOBRAW(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كوبرا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'كوبرا')
local COBRA_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..COBRA_Msg[math.random(#COBRA_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevCOBRAW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,COBRA)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝘾𝙊 ━━━━━━━•*\n"
x = 0
local list = COBRA.members_
for k, v in pairs(list) do
x = x + 1
...
if COBRASudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevCOBRAW(msg) then 
...
if text == ("ردود المطور") and DevCOBRAW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ❂︙قائمة ردود المطور \n*•━━━━━━ 𝘾𝙊 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevCOBRAW(msg) then    
send(msg.chat_id_, msg.id_,' *❂︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevCOBRAW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'كوبرا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevCOBRAW(msg) then   
...
if text == 'تعطيل المغادره' and DevCOBRAW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*❂︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'shorohat10')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'CoBBRa_TEAM')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
COBRAdx(msg.chat_id_, msg.id_, ' *❂︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*❂︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*❂︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*❂︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevCOBRAW(msg) then
...
{{text = '𝙘𝙤𝙗𝙧𝙖 𝙩𝙚𝙖𝙢 🝝', url="t.me/shorohat10"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𝙘𝙤𝙗𝙧𝙖 𝙩𝙚𝙖𝙢 🝝', url="t.me/shorohat10"}},
{{text = 'مطور السورس', url="t.me/JO_CR0"}},
}
...
send(msg.chat_id_, msg.id_, t..'ٴ❂∫ٴ*•━━━━━━ 𝘾𝙊 ━━━━━━━•*ٴ❂∫○ٴ\n❂︙[𝙘𝙤𝙗𝙧𝙖 𝙩𝙚𝙖𝙢 🝝](t.me/CoBBRa_TEAM) ')
end
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴄᴏʙʀᴀ',url='http://t.me/shorohat10'}},
}
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'كوبرا')
...
COBRA = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(COBRA)
...
------------------------------------------------------------------------
local COBRAAbot = database:get(bot_id.."COBRA1:Add:Filter:Rp2"..text..result.chat_id_)   
if COBRAAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *❂︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n❂︙["..COBRAAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local COBRA1_Msg = database:get(bot_id.."COBRA1:Add:Filter:Rp2"..text..result.chat_id_)   
if COBRA1_Msg then
send(msg.chat_id_, msg.id_," ❂︙"..COBRA1_Msg)
